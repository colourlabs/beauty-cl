...
//---------------------------------------------------------------------------
BEAUTY_EXPORT
std::shared_ptr<response> bad_request(const beauty::request &req,
                                      const char *message);
...
//---------------------------------------------------------------------------
BEAUTY_EXPORT
std::shared_ptr<response> not_found(const beauty::request &req);

//---------------------------------------------------------------------------
// Returns a server error response
//---------------------------------------------------------------------------
BEAUTY_EXPORT
std::shared_ptr<response> server_error(const beauty::request &req,
                                       const char *what);
} // namespace helper
...
BEAUTY_EXPORT
std::vector<std::string_view> split(const std::string_view &str_view,
                                    char sep = '/');
